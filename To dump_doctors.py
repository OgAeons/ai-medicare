...
df = pd.read_csv('server/dataset/doctors-by-specialtiy-reduced.csv', delimiter=',', quotechar='"', skipinitialspace=True)
...
print("Data inserted successfully into the 'doctors' collection.")