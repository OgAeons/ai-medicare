  ...
  return (
    <div className='no-select h-auto mx-[3rem] my-[1rem]'>
      ...
      <div className='relative text-gray-800 w-full h-[57vh] mt-6 rounded-2xl flex flex-col items-center justify-start shadow-md'>
        <div className='bg-blue-600 p-8 w-full h-[43vh] flex items-start justify-center rounded-2xl shadow-md'>
          <div className='flex items-center'>
            ...
            <a href='/symptoms' className='bg-white text-blue-600 mx-8 py-4 text-md w-1/5 text-center rounded-2xl shadow-lg'>
        ...
        <div className='absolute top-48 w-[90vw] right-5 flex items-center justify-center'>
            <div className='bg-white w-1/4 h-[30vh] mx-4 py-8 px-6 flex flex-col items-center rounded-2xl shadow-md'>
                <div className='bg-blue-300 p-4 mb-4 w-fit rounded-xl'>
        ...
        <div className='bg-white text-gray-800 w-full py-4 mb-4 rounded-2xl flex flex-col items-center justify-center shadow-md'>
              ...
              {tests.map((test) => (
                <li
                  ...
                  className={`text-gray-500 px-4 py-2 flex items-center border-b-4 ${
                    activeTest === test ? 'bg-blue-100 text-blue-700 border-blue-600 rounded-t-md shadow-md' : 'border-transparent'
          ...
          <div className='py-2 my-2 w-[90%] flex items-center justify-between'>
            <div className='relative w-1/4 py-2 px-6 mr-6 flex items-center border rounded-2xl shadow-md'>
              <div className='bg-blue-600 rounded-3xl w-10 h-10 flex items-center justify-center' onClick={toggleLocationDetails}>
                <FaMapMarkerAlt size={24} color='white' />
              </div>
            ...
            <div className='relative w-1/4 py-2 px-4 mr-6 flex items-center border rounded-2xl shadow-md cursor-pointer'>
              <div className='rounded-3xl w-10 h-10 flex items-center justify-center border border-blue-600' onClick={toggleCalendar}>
                <FaCalendarAlt size={24} color='#2663f3' />
              </div>
            ...
            <div className='relative w-1/4 py-2 px-6 mr-6 flex items-center border rounded-2xl shadow-md cursor-pointer'>
              <div className='rounded-3xl w-10 h-10 flex items-center justify-center border border-blue-600' onClick={toggleAppointmentGender}>
                {appointmentGender === 'Kids' ? <FaBabyCarriage size={24} color='#2663f3' /> : <FaUserMd size={24} color='#2663f3' />}
              </div>
              ...
              {showAppointmentGender && (
                <div className='absolute top-full mt-2 left-0 z-50 bg-white shadow-lg rounded-lg p-4'>
                  {['Adult Male', 'Adult Female', 'Kids'].map((option) => (
                    <div key={option} className='px-4 py-2 hover:bg-blue-100 cursor-pointer' onClick={() => handleAppointmentGenderChange(option)}>
                      {option}
                    </div>
                  ))}
                </div>
            ...
            <div className='bg-blue-600 text-white w-1/4 py-4 px-6 mr-6 flex items-center justify-center border rounded-2xl shadow-md cursor-pointer' onClick={handleSearch}>
              <BiSearch size={24} />
