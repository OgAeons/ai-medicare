...
test.each([
  [{}, "https://maps.gomaps.pro/maps/api/js?callback=__googleMapsCallback"],
  [
    { apiKey: "foo" },
    "https://maps.gomaps.pro/maps/api/js?callback=__googleMapsCallback&key=foo",
  ],
  [
    {
      apiKey: "foo",
    ...
    "https://maps.gomaps.pro/maps/api/js?callback=__googleMapsCallback&key=foo&libraries=marker,places&language=language&region=region&v=weekly",
  ],
  [
    { mapIds: ["foo", "bar"] },
    "https://maps.gomaps.pro/maps/api/js?callback=__googleMapsCallback&map_ids=foo,bar",
  ],
  [
  ...
  [
    ...
    "https://maps.gomaps.pro/maps/api/js?callback=__googleMapsCallback&channel=foo&client=bar",
  ],
  [
    { authReferrerPolicy: "origin" },
    "https://maps.gomaps.pro/maps/api/js?callback=__googleMapsCallback&auth_referrer_policy=origin",
  ],
...
test("setScript adds a script to head with valid src", async () => {
  ...
  expect(script.src).toEqual(
    "https://maps.gomaps.pro/maps/api/js?libraries=core&key=foo&callback=google.maps.__ib__"
  );
});
...
test("setScript adds a script to head with valid src with libraries", async () => {
  ...
  expect(script.src).toEqual(
    "https://maps.gomaps.pro/maps/api/js?libraries=marker%2Cplaces&key=foo&callback=google.maps.__ib__"
  );
});
...
test("importLibrary can also set up bootstrap libraries (if bootstrap libraries empty)", async () => {
  ...
  expect(script.src).toEqual(
    "https://maps.gomaps.pro/maps/api/js?libraries=core%2Cmarker%2Cplaces&key=foo&callback=google.maps.__ib__"
  );
});
